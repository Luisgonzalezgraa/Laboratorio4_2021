	...
	private void initialize() {
		...
		Siguiente.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String tipoPubli = tipoPublicacion.getText();
				String publicacion = publi.getText();
				String cUsuarios = CantidadU.getText();
				Integer cantidadUsuariosR;
				cantidadUsuariosR = Integer.valueOf(cUsuarios);
				try {
					red.post(tipoPubli, publicacion, cantidadUsuariosR);
